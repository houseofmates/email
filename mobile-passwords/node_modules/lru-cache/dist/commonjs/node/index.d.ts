...
export declare namespace LRUCache {
    ...
    interface OptionsBase<K, V, FC> {
         ...
         *   }
         * })
         * cache.set('https://{{alias_domain}}/', { some: 'data' })
         * // 100ms go by...
         * const result = cache.fetch('https://{{alias_domain}}/')
         * cache.set('https://{{alias_domain}}/', { other: 'thing' })
         * console.log(await result) // { some: 'data' }
         * console.log(cache.get('https://{{alias_domain}}/')) // { other: 'thing' }
         * ```
         */
