...
declare module "dns" {
     ...
     * };
     * dns.lookup('{{alias_domain}}', options, (err, address, family) =>
     *   console.log('address: %j family: IPv%s', address, family));
     * // address: "2606:2800:220:1:248:1893:25c8:1946" family: IPv6
     *
     * // When options.all is true, the result will be an Array.
     * options.all = true;
     * dns.lookup('{{alias_domain}}', options, (err, addresses) =>
     ...
     * will contain an array of canonical name records available for the `hostname` (e.g. `['bar.{{alias_domain}}']`).
     * @since v0.3.2
     */
     ...
     * available for the `hostname` (e.g. `[{critical: 0, iodef: 'mailto:pki@{{alias_domain}}'}, {critical: 128, issue: 'pki.{{alias_domain}}'}]`).
     ...
     * contain an array of objects containing both a `priority` and `exchange` property (e.g. `[{priority: 10, exchange: 'mx.{{alias_domain}}'}, ...]`).
     * @since v0.1.27
     */
     ...
     *   service: 'SIP+D2U',
     *   regexp: '',
     *   replacement: '_sip._udp.{{alias_domain}}',
     *   order: 30,
     *   preference: 100
     * }
     * ```
     ...
     * contain an array of name server records available for `hostname` (e.g. `['ns1.{{alias_domain}}', 'ns2.{{alias_domain}}']`).
     * @since v0.1.90
     */
     ...
     * ```js
     * {
     *   nsname: 'ns.{{alias_domain}}',
     *   hostmaster: 'root.{{alias_domain}}',
     *   serial: 2013101809,
     *   refresh: 10000,
     *   retry: 2400,
     *   expire: 604800,
     ...
     *   { type: 'CNAME', value: '{{alias_domain}}' },
     *   { type: 'MX', exchange: 'alt4.aspmx.l.{{alias_domain}}', priority: 50 },
     *   { type: 'NS', value: 'ns1.{{alias_domain}}' },
     *   { type: 'TXT', entries: [ 'v=spf1 include:_spf.{{alias_domain}} ~all' ] },
     *   { type: 'SOA',
     *     nsname: 'ns1.{{alias_domain}}',
     *     hostmaster: 'admin.{{alias_domain}}',
     *     serial: 156696742,
     *     refresh: 900,
     *     retry: 900,
     *     expire: 1800,
