...
declare module "url" {
     ...
     * });
     *
     * // => 'https://{{alias_domain}}/some/path?page=1&#x26;format=json'
     * ```
     *
     ...
     * url.resolve('http://{{alias_domain}}/', '/one');    // 'http://{{alias_domain}}/one'
     * url.resolve('http://{{alias_domain}}/one', '/two'); // 'http://{{alias_domain}}/two'
     * ```
     *
     ...
     * resolve('http://{{alias_domain}}/', '/one');    // 'http://{{alias_domain}}/one'
     * resolve('http://{{alias_domain}}/one', '/two'); // 'http://{{alias_domain}}/two'
     * ```
     * @since v0.1.25
     * @legacy Use the WHATWG URL API instead.
    ...
    class URL {
         ...
         *
         * myURL.host = '{{alias_domain}}:82';
         * console.log(myURL.href);
         * // Prints https://{{alias_domain}}:82/foo
         * ```
         *
         ...
         * myURL.hostname = '{{alias_domain}}';
         * console.log(myURL.href);
         * // Prints https://{{alias_domain}}:81/foo
         *
         ...
         *
         * myURL.href = 'https://{{alias_domain}}/bar';
         * console.log(myURL.href);
         * // Prints https://{{alias_domain}}/bar
         * ```
         *
         ...
         *
         * ```js
         * const myURL = new URL('https://abc:xyz@{{alias_domain}}');
         * console.log(myURL.password);
         * // Prints xyz
         *
         * myURL.password = '123';
         * console.log(myURL.href);
         * // Prints https://abc:123@{{alias_domain}}/
         * ```
         *
         ...
         * myURL.username = '123';
         * console.log(myURL.href);
         * // Prints https://123:xyz@{{alias_domain}}/
         * ```
         *
         ...
         * ```js
         * const myURLs = [
         *   new URL('https://www.{{alias_domain}}'),
         *   new URL('https://test.example.org'),
         * ];
         * console.log(JSON.stringify(myURLs));
         * // Prints ["https://www.{{alias_domain}}/","https://test.example.org/"]
         * ```
         */
        toJSON(): string;
    }
