 ...
 *
 *    res.links({
 *      next: 'http://api.{{alias_domain}}/users?page=2',
 *      last: 'http://api.{{alias_domain}}/users?page=5',
 *      pages: [
 *        'http://api.{{alias_domain}}/users?page=1',
 *        'http://api.{{alias_domain}}/users?page=2'
 *      ]
 *    });
 *
 * @param {Object} links
 ...
 *    res.location('http://{{alias_domain}}');
 *    res.location('../login');
 *
 * @param {String} url
 * @return {ServerResponse} for chaining
 ...
 *    res.redirect('http://{{alias_domain}}');
 *    res.redirect(301, 'http://{{alias_domain}}');
