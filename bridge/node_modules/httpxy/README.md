...
const res = await proxyFetch("http://127.0.0.1:3000", "http://{{alias_domain}}/api/data");
...
const res3 = await proxyFetch({ host: "127.0.0.1", port: 3000 }, "http://{{alias_domain}}/api/data");

// Using a Request object
const req = new Request("http://{{alias_domain}}/api/data", {
  method: "POST",
...
const res5 = await proxyFetch("http://127.0.0.1:3000", "http://{{alias_domain}}/api/data", {
  method: "PUT",
